...
-- Disk的极限值得到了进一步提升，提升到了[-600, 600][rpm]
...
class GyroscopeEnvNew4PaperV0(gym.Env):
    ...
    def init_gyro(self):
        ...
        self.maxDiskSpeed = 600 * 2 * np.pi / 60 # rad/s
        
    # Initialize simulation parameters
    def init_simu(self, dt = 0.02, ep_len = 100, seed = 2, friction = False):

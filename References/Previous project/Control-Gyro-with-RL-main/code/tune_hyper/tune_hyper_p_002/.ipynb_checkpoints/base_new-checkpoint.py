...
# Parameters chosen based on the result of 2rd iteration
...
spinup.ddpg_pytorch(env_fn_, 
                    ...
                    act_noise = 0.1,
                    max_ep_len = 100, 
                    logger_kwargs = dict(output_dir='iter2_base_new', exp_name='iter2_base_new'))
...
metrics_man.to_csv('iter2_metrics_base_new.csv',index=True)